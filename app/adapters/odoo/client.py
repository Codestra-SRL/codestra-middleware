...
ODOO_ENDPOINTS = {
    ...
    "leads.find_by_external_key": "odoo.leads.find_by_external_key",
    "leads.find_duplicate_candidates": "odoo.leads.find_duplicate_candidates",
    "leads.create_crm_lead": "odoo.leads.create_crm_lead",
    "health.check": "odoo.health.check",
...
ODOO_READ_OPERATIONS = frozenset(
    {
        ...
        "agents.read",
        "leads.read",
        "leads.find_by_external_key",
        "leads.find_duplicate_candidates",
        "health.check",
        "campaigns.read",
        "traces.read",
