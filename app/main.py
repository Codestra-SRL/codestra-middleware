...
from app.api.v1.trading_pilot import router as trading_pilot_router
...
from app.api.v1.ai_memory_knowledge import router as ai_memory_knowledge_router
...
from app.api.v1.ai_pilot import router as ai_pilot_router
...
app.include_router(ai_workforce_router)
app.include_router(ai_memory_knowledge_router)
app.include_router(ai_tools_router)
app.include_router(ai_collaboration_router)
app.include_router(ai_evaluation_router)
app.include_router(control_tower_router)
app.include_router(ai_pilot_router)
...
app.include_router(trading_pilot_router)
