...
AI_WORKFLOWS = Counter("codestra_ai_workflows_total", "AI workflows", ["status"])
AI_WORKFLOW_TRANSITIONS = Counter("codestra_ai_workflow_transitions_total", "Workflow transitions", ["from_status", "to_status"])
AI_WORKFLOW_ACTIVE = Gauge("codestra_ai_workflow_active", "Active durable workflows")
AI_WORKFLOW_WAITS = Gauge("codestra_ai_workflow_waits", "Durable waits", ["wait_type"])
AI_WORKFLOW_RETRIES = Counter("codestra_ai_workflow_retries_total", "Bounded task retries", ["classification"])
AI_WORKFLOW_DEAD_LETTERS = Gauge("codestra_ai_workflow_dead_letters", "Workflow dead letters")
AI_WORKFLOW_APPROVALS = Counter("codestra_ai_workflow_approvals_total", "Human approval decisions", ["decision"])
AI_WORKFLOW_RECONCILIATION = Gauge("codestra_ai_workflow_reconciliation_pending", "Workflow reconciliation backlog", ["provider"])
AI_WORKFLOW_DEADLINE_RISK = Gauge("codestra_ai_workflow_deadline_risk", "Workflows at deadline risk", ["risk"])
