...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("command_id", uuid, nullable=False),
        sa.Column("state", sa.String(32), nullable=False),
        sa.Column("adapter_identity", sa.String(144), nullable=False),
    ...
    op.create_table(
        ...
        sa.CheckConstraint("sequence >= 1", name="ck_telephony_transition_sequence"),
        sa.ForeignKeyConstraint(
            ["operation_id"],
    ...
    op.create_index(
        "ix_telephony_transition_correlation",
        "telephony_operation_transition",
        ["correlation_id"],
    )
    op.create_table(
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_telephony_transition_correlation",
        table_name="telephony_operation_transition",
    )
