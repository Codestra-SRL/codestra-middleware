...
| Middleware-to-Odoo result delivery | `app/adapters/odoo/lead_automation.py` | Odoo client contract | NOT_APPLICABLE |
...
For the HMAC caller, version, method, path, body digest, timestamp, nonce,
